...
<html>
  <head>
    <link rel="stylesheet" type="text/css" href="CSS/Vistaciudadanos.css"/>      
  </head>
  <body>
    ...
    <div class="caja">
          <div class="titulin">
          <h2><span>Está a punto de votar a <?php echo $ArrayPartido['3']['NOMBRE'] ?></span></h2>
          ...
          <form id="formulario" method="post" action="controlador_Votaciones.php">
          	...
          	<input type="checkbox" class="check" id="partido" name="partido" value="4" required></input>
