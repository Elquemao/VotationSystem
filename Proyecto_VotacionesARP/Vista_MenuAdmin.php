...
<head>
	...
	<link rel="stylesheet" href="CSS/Vista_MenuAdmin.css">
</head>
<body>
	...
	<div id="titulo">
        ...
        <p id="subheader">Panel de Administrador</p>
	</div>
	...
	<header>
		...
		<a href="Vista_Escrutinio.php">
			<div class="contenedor" id="dos">
				<img class="icon" src="pictures/magnifier.png">
				<p class="texto">Escrutinio</p>
			</div>
		</a>

		<a href="controlador_ListaCenso.php">
			<div class="contenedor" id="tres">
				
					<img class="icon" src="pictures/open-magazine.png">
					<p class="texto">Listado Censo</p>
